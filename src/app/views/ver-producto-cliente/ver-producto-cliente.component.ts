...
export class VerProductoClienteComponent {
  ...
  constructor(private fb: FormBuilder) {
    ...
    this.model = new Producto("1", "Burro Ñoño", 12, 12000,"unidades",  this.imageUrl, "Tortilla pequeña, proteína a elegir, tocineta premium, trocitos de chorizo coctel, queso Americano, salsa de frijol refrito, guacamole, lechuga, pico de gallo y slasa de la casa.");
    this.precio = "";
    this.change(1);
  }
